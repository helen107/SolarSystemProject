...
public class EarthContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.earth_content);

        swipeLayout = findViewById(R.id.earth_content_contraint_layout);
